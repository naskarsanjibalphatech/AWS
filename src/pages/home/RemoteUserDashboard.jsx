...
const initialGates = Array.from({ length: GATE_COUNT }, (_, i) => ({
  id: i + 1,
  position: [6.2, 4.8, 3.1, 0, 7.5, 2.0][i],
...
function GateVisualization({ gate }) {
  ...
  return (
    ...
    >
      ...
      {/* Gate leaf */}
      <g style={hoistStyle}>
        <rect x={cx - gateW / 2 + 2} y={clampedGateTop} width={gateW - 4} height={gateH} fill="#b5532f" stroke="#7a3a1f" strokeWidth="1.5" rx="1" />
      ...
      {/* Status lamp */}
      <circle cx={cx} cy="7" r="4.5" fill={gate.olrTrip ? "#f87171" : raising ? "#34d399" : lowering ? "#fbbf24" : "#3a4a5a"} stroke="#0a1620" strokeWidth="1">
    ...
    <div className="db-root">
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* GATE GRID — 2 columns with clear gap */
        .db-gate-grid {
          display: grid;
        ...
        /* GATE CARD */
        .db-card { background: var(--surf); border: 1px solid var(--bdr); border-radius: 14px; overflow: hidden; transition: border-color .2s; }
        ...
        .db-status-dot { width: 8px; height: 8px; border-radius: 50%; background: var(--bdr2); flex-shrink: 0; }
        ...
        /* VISUALIZATION */
        .db-viz { position: relative; height: 220px; overflow: hidden; background: #0a1620; }
        ...
        /* FLAGS */
        .db-flags { display: flex; flex-direction: column; gap: 6px; padding: 12px 16px 16px; }
        ...
        @media (max-width: 900px) {
          ...
          .db-gate-grid { gap: 18px; padding: 18px; }
        }
        ...
        @media (max-width: 640px) {
          ...
          .db-gate-grid { grid-template-columns: 1fr; padding: 14px; gap: 16px; }
          .db-viz { height: 200px; }
      ...
      <header className="db-topbar">
        <div className="db-brand">
          ...
          Barrage Gate SCADA — Remote View
          <span className="db-brand-sub">· View only · Live</span>
        </div>
      ...
      {tripCount > 0 ? (
        ...
        <div className="db-banner">
          ...
          <div>
            <p className="bt">System online</p>
            <p className="bd">Loaded {gates.length} barrage gates · All telemetry healthy</p>
          </div>
        </div>
      )}
      ...
      <div className="db-sec">
        <h2><Activity size={15} /> Gate groups <span className="sub">— spillway &amp; canal regulators</span></h2>
      ...
      <footer className="db-footer">
        <span><Waves size={11} style={{ verticalAlign: "-1px", marginRight: 5 }} />Canal Barrage Control System · Remote viewer</span>
